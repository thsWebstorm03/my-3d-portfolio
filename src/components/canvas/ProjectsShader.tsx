...
const ProjectsShader: React.FC = () => {
   ...
   const images = [
...

      {
         ...
         src: "/img/projects/Shopify.png",
         url: "https://vortexvr.eu/",
      },

      {
         title: "Poker",
         position: [0.1, -4 + posY, -0.09],
         src: "/img/projects/poker.png",
         url: "https://app.simstudio.io",
      },
      {
         title: "Healthcare",
         position: [-0.1, -5 + posY, -0.09],
         src: "/img/projects/Healthcare.png",
         url: "https://www.mynectarhealth.com/",
      },
   ];
                  ...
                  {images.map((image, i) => {
                     ...
                     return (
                        <group key={url}>
                           ...
                           <Text
                              position={
                                 [-position[0], position[1], 0.4] as Vector3
                              }
                              strokeWidth={"0.1%"}
                              strokeOpacity={0.4}
                              strokeColor="#ffffff"
